...
export default function Dashboard() {
  ...
  const [portfolioParams, setPortfolioParams] = useState<SimulationParams | null>(null);
  ...
  return (
    <>
      <div className="min-h-screen p-8 max-w-7xl mx-auto bg-black">
        {/* Header Section */}
        ...
        {results && portfolioParams && (
          <div className="mt-8 pt-8 border-t border-zinc-800 flex justify-end">
            <ExportReportButton 
              simulationResults={results} 
              currentPortfolio={{
                tickers: Object.keys(portfolioParams.weightsNormalised),
                weights: Object.values(portfolioParams.weightsNormalised)
              }} 
            />
          </div>
        )}
      ...
      <CopilotWidget 
        simulationResults={results}
        currentPortfolio={portfolioParams ? {
          tickers: Object.keys(portfolioParams.weightsNormalised),
          weights: Object.values(portfolioParams.weightsNormalised)
        } : null}
      />
